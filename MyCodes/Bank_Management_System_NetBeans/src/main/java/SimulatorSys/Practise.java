...
public class Practise {
    ...
    private char returnStrPos(double g)// takes the grayscale values as parameter
    {
        final char str;
        ...
        return str; //returns the character
    }
            ...
            public void run(){
                ...
                while(fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION){
                    try{
                        ...
                        final JDialog dialog = new JOptionPane(new JScrollPane(textArea), JOptionPane.PLAIN_MESSAGE).createDialog(Practise.class.getName());
