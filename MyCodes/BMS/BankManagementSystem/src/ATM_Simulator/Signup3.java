...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(String formno){
        this.formno = formno;
        setTitle("NEW ACCOUNT AAPLICATION FORM - PAGE 3");
        ...
        l4 = new JLabel("XXXX-XXXX-XXXX-9167");
        ...
        try{
            if(ae.getSource()==b1){
                if(atype.equals("")){
                    ...
                    Conn c1 = new Conn();
                    //Need to write corresponding table name 
                    String q1 = "INSERT INTO <TABLE NAME> VALUES('"+formno+"', '"+atype+"', '"+cardno+"', '"+pin+"', '"+facility+"')";
                    String q2 = "INSERT INTO <TABLE NAME> VALUES('"+formno+"', '"+cardno+"', '"+pin+"')";
