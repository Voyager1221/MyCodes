...
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno){
        ...
        String religion[] = {"Hindu", "Muslim", "Sikh", "Christian", "Jew", "Other"};
        ...
        String education[] = {"Non-Graduated", "Graduated", "Post-Graduated", "Doctrate","10th Pass","10+2 Pass"};
        ...
        l4.setBounds(350, 220, 320, 30);
        add(l4);

        c3.setBounds(350, 220, 320, 30);
        add(c3);

        l5.setBounds(100, 270, 320, 30);
        add(l5);
        ...
        r2.setBounds(460, 390, 100, 30);
        add(r2);

        l10.setBounds(350, 540, 100, 30);
        add(l10);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t2.getText().equals("")){
                ...
                Conn c1 = new Conn();
                //Need to add corresponding table name
                String q1 = "INSERT INTO <TABLE NAME> VALUES('"+formno+"', '"+religion+"', '"+category+"', '"+income+"', '"+education+"', '"+occupation+"', '"+pan+"', '"+aadhar+"', '"+scitizen+"', '"+eaccount+"')";
