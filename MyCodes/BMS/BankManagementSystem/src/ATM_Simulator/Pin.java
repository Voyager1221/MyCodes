...
public class Pin extends JFrame implements ActionListener{
    ...
    Pin(String pin){
        ...
        b1.setBounds(390, 588, 150, 25);
        l4.add(b1);

        b2.setBounds(390, 48, 140, 35);
        l4.add(b2);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource()==b1){
                ...
                Conn c1 = new Conn();
                //Need to add corresponding table names
                String q1 = "UPDATE <TABLE NAME> SET PIN = '"+rpin+"' WHERE PIN = '"+pin+"'";
                String q2 = "UPDATE <TABLE NAME> SET PIN = '"+rpin+"' WHERE PIN = '"+pin+"'";
                String q3 = "UPDATE <TABLE NAME> SET PIN = '"+rpin+"' WHERE PIN = '"+pin+"'"; 
